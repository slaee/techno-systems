...
const ActivityTemplateService = {
	...
	getActivityTemplate: (templateId) =>
		api.get(`${BASE_URL}/${templateId}`),
	...
	*/
	updateActivityTemplate: (templateId, data) =>
		api.put(`${BASE_URL}/${templateId}`, data),

	/// DELETE /activity-templates/{template_id}
	deleteActivityTemplate: (templateId) =>
		api.delete(`${BASE_URL}/${templateId}`),
